...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.Date.setStyleSheet("background-color: rgb(133, 165, 255);\n"
"color: rgb(0, 0, 0);")
